...
<body>
  <p class="subtitle">Event Brief — EventOps AI</p>
  <h1>${bp.eventName}</h1>
  ...
  <p class="footer">Generated by EventOps AI · ${new Date().toLocaleDateString("en-CA", { year: "numeric", month: "long", day: "numeric" })}</p>
</body>
</html>`;
}
